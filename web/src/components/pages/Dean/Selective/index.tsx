...
const Selective = () => {
    ...
    //     return state.users.doctors.filter(doctor => doctor.position === profile.position);
    // });
    // const nurses = useSelector(state => state.users.nurses)
    ...
    //                         dispatch(updateOneNurse(newNurseSelected));
    //                         socket.emit('users:nurses:update', newNurseSelected); ////
    //                     }
    //                     else console.warn(message);
    //                 })
    //                 .catch(err => console.log(err))
    ...
    //                     const { message } = res.data;
    //                     if (message === 'updated user') {
    //                         dispatch(updateOneDoctor(newDoctorSelected));
    //                         socket.emit('users:doctors:update', newDoctorSelected); ////
    //                     }
    //                     else console.warn(message);
    //                 })
    //                 .catch(err => console.log(err))
    //             dispatch(notifyInfo('Đã chọn bác sĩ, y tá cho bệnh nhân!'));
    //             setTimeout(() => {
    //                 dispatch(hideNotify());
    //             }, 3500)
    //             setPatientSelected({});
